...
_NL_LANG_PACKS = {
    ...
    # --- Cyrillic pack: Russian (pure data; see schema above) -----------
    "ru": {
        # Russian flexes by suffix across cases/numbers; the 2-char
        # ending table plus trailing-vowel drop covers the frequent
        # forms («алиасов»→«алиас*», «серверы»→«сервер*»).
        "stopwords": frozenset(
            """
        ...
        "affinity_stopwords": frozenset(
            ...
            нужно надо есть был была было будут которые
            """.split()
        ),
